...
<head>
	...
	<title>Simple Conversions | Convert any Commonly Used Units of Measure</title>
...
<div id="sitewrapper">
	...
	<ul>
		...
		<li><a<?php if ($type == "time") { print ' class="active"'; } ?> href="/?type=time">Time</a></li>
	</ul>
	...
	<form action="calculate.php" method="post"<?php if ($type != "time") { print ' class="inactive"'; } ?>>
		<fieldset>
			<?php if ($type == "time") { print $hidden; } ?>
			<label>From</label>
			<select name="from">
				<option value="1">second</option>
				<option value="2">millisecond</option>
				<option value="3">microsecond</option>
				<option value="4">nanosecond</option>
				<option value="5">picosecond</option>
				<option value="6">femtosecond</option>
				<option value="7">attosecond</option>
				...
				<option value="14">month (synodic)</option>
				<option value="15">year</option>
				<option value="16">year (Julian)</option>
				<option value="17">year (leap)</option>
				<option value="18">year (tropical)</option>
				<option value="19">year (sidereal)</option>
				<option value="20">day (sidereal)</option>
				<option value="21">hour (sidereal)</option>
				<option value="22">minute (sidereal)</option>
				<option value="23">second (sidereal)</option>
				<option value="24">fortnight</option>
				<option value="25">decade</option>
				<option value="26">century</option>
				<option value="27">millennium</option>
				<option value="28">septennial</option>
				<option value="29">octennial</option>
				<option value="30">novennial</option>
				<option value="31">quindecennial</option>
				<option value="32">quinquennial</option>
				<option value="33">Planck time</option>
			</select>
			<label>to</label>
			<select name="to">
				<option value="1">second</option>
				<option value="2" selected="selected">millisecond</option>
				<option value="3">microsecond</option>
				<option value="4">nanosecond</option>
				<option value="5">picosecond</option>
				<option value="6">femtosecond</option>
			...
			<input class="input-text" type="text" name="amount" />
			<input class="btn_submit" type="submit" value="Calculate" />
			<?php if ($type == "time" && $result != NULL) { print $result; } ?>
		</fieldset>
	</form>
</div>
